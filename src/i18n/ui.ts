...
export const ui = {
  ...
  pt: {
    ...
    "game.option.choose": "Escolha",
    "game.options.available": "Opções de resposta estão agora disponíveis",
    "game.time.remaining.seconds": "Restam {seconds} segundos",
  ...
  da: {
    ...
    "game.puzzle.label": "Album Cover Puslespil",
    "game.puzzle.loading": "Indlæser puslespil...",
    "game.options.legend": "Vælg det rigtige album",
  ...
  nl: {
    ...
    "game.instructions.puzzle":
      "Probeer het album te raden terwijl de hoes geleidelijk wordt onthuld. Hoe sneller je correct raadt, hoe meer punten je verdient.",
    "game.time.remaining": "Resterende tijd:",
    "game.puzzle.label": "Album Hoes Puzzel",
    "game.puzzle.loading": "Puzzel laden...",
    "game.options.legend": "Kies het juiste album",
    "game.next.round": "Begin volgende ronde",
    ...
    "game.time.remaining.seconds": "Nog {seconds} seconden",
  ...
  sv: {
    ...
    "game.puzzle.label": "Albumomslag Pussel",
    ...
    "game.time.up": "Tiden är ute! Det rätta albumet var:",
    ...
    "game.instructions.puzzle":
      "Yritä arvata albumi, kun kansi paljastuu vähitellen. Mitä nopeammin arvaat oikein, sitä enemmän pisteitä ansaitset.",
    "game.time.remaining": "Jäljellä oleva aika:",
    "game.puzzle.label": "Albumin Kansi Palapeli",
    "game.puzzle.loading": "Ladataan palapeliä...",
    "game.options.legend": "Valitse oikea albumi",
    "game.next.round": "Aloita seuraava kierros",
    "game.puzzle.revealed": "Albumin kannesta on paljastettu {percent}%",
