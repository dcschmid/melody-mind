...
export const ui = {
  ...
  pt: {
    ...
    "highscore.name": "Nome",
    "highscore.points": "Pontos",
    "highscore.category.top10": "Top 10 Jogadores em",
    ...
    "golden.lp.title": "Parabéns!",
    "golden.lp.message.1": "Você ganhou o disco de ouro",
    "golden.lp.message.2": "e conquistou o título",
    "golden.lp.score": "Pontos obtidos:",
    "golden.lp.restart": "Novo Jogo",
    "golden.lp.restart.label": "Iniciar um novo jogo",
  ...
  da: {
    ...
    "highscore.category.top10": "Top 10 Spillere i",
    ...
    "golden.lp.title": "Tillykke!",
    "golden.lp.message.1": "Du har vundet den gyldne",
    "golden.lp.message.2": "plade og opnået titlen",
    "golden.lp.score": "Opnåede point:",
    "golden.lp.restart": "Nyt Spil",
    "golden.lp.restart.label": "Start et nyt spil",
  ...
  nl: {
    ...
    "highscore.rank": "Rang",
    "highscore.name": "Naam",
    "highscore.points": "Punten",
    "highscore.category.top10": "Top 10 Spelers in",
    ...
    "golden.lp.title": "Gefeliciteerd!",
    "golden.lp.message.1": "Je hebt de gouden",
    "golden.lp.message.2": "plaat gewonnen en de titel behaald",
    "golden.lp.score": "Behaalde punten:",
    "golden.lp.restart": "Nieuw Spel",
    "golden.lp.restart.label": "Start een nieuw spel",
  ...
  sv: {
    ...
    "highscore.name": "Namn",
    "highscore.points": "Poäng",
    "highscore.category.top10": "Topp 10 Spelare i",
    ...
    "golden.lp.title": "Grattis!",
    "golden.lp.message.1": "Du har vunnit den gyllene",
    "golden.lp.message.2": "skivan och uppnått titeln",
    "golden.lp.score": "Uppnådda poäng:",
    "golden.lp.restart": "Nytt Spel",
    "golden.lp.restart.label": "Starta ett nytt spel",
    ...
    "highscore.name": "Nimi",
    "highscore.points": "Pisteet",
    "highscore.category.top10": "Top 10 Pelaajat kategoriassa",
    ...
    "golden.lp.title": "Onnittelut!",
    "golden.lp.message.1": "Voitit kultaisen",
    "golden.lp.message.2": "levyn ja ansaitsit tittelin",
    "golden.lp.score": "Saavutetut pisteet:",
    "golden.lp.restart": "Uusi Peli",
    "golden.lp.restart.label": "Aloita uusi peli",
