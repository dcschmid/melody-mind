export default {
  ...
  "game.timepressure.seconds": "seconds",
  ...
  "pages.privacy.turso_storage": "We store certain data in Turso for fast edge access.",
  ...
  "pages.imprint.legal_notice_intro": "Legal notice — this page contains the provider's legal and contact information.",
