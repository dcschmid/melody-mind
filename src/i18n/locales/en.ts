export default {
  ...
  "auth.guest.button": "Play as Guest",
  "auth.guest.description": "Play instantly without signing up. Progress won't be saved.",
  "auth.guest.benefits": "With an account you can:",
  "auth.guest.benefit.progress": "Save game progress",
  "auth.guest.benefit.achievements": "Unlock achievements",
  "auth.guest.benefit.leaderboard": "Join leaderboards",
  "auth.guest.benefit.stats": "Track detailed statistics",
  "auth.guest.or": "or",
  ...
  "auth.oauth.continue_with": "Continue with",
  "auth.oauth.link_accounts": "Link your accounts",
  "auth.oauth.already_linked": "Already linked",
  "auth.oauth.loading_providers": "Loading authentication providers...",
  "auth.oauth.providers_error": "Failed to load authentication providers",
  "auth.oauth.no_providers": "No authentication providers available",
  "auth.oauth.retry": "Retry",
  "auth.oauth.invalid_provider": "Invalid authentication provider",
  "auth.oauth.invalid_callback": "Invalid authentication callback",
  "auth.oauth.provider_error": "Authentication provider error",
  "auth.oauth.authorization_failed": "Authorization failed",
  "auth.oauth.callback_failed": "Authentication callback failed",
  "auth.oauth.providers_failed": "Failed to load providers",
  "auth.oauth.unlink_success": "{provider} account unlinked successfully",
  "auth.oauth.unlink_failed": "Failed to unlink {provider} account",
  "auth.oauth.provider_not_linked": "This provider is not linked to your account",
  "auth.oauth.linked_accounts": "Connected Accounts",
  "auth.oauth.linked_accounts_description": "Manage your connected social media accounts",
  "auth.oauth.spotify.description": "Connect your Spotify account",
  "auth.oauth.google.description": "Connect your Google account",
  "auth.oauth.apple.description": "Connect your Apple ID",
  "auth.oauth.discord.description": "Connect your Discord account",
  "auth.oauth.yahoo.description": "Connect your Yahoo account",
  "auth.oauth.linked": "Connected",
  "auth.oauth.not_linked": "Not connected",
  "auth.oauth.link": "Connect",
  "auth.oauth.unlink": "Disconnect",
  "auth.oauth.link_provider": "Connect {{provider}}",
  "auth.oauth.unlink_provider": "Disconnect {{provider}}",
  "auth.oauth.unlink_confirm_title": "Disconnect Account",
  "auth.oauth.unlink_confirm_message": "Are you sure you want to disconnect {{provider}}?",
  "auth.oauth.cancel": "Cancel",
  "auth.oauth.confirm": "Confirm",
  "auth.oauth.cannot_unlink_last_method": "Cannot disconnect the last authentication method",
  "auth.oauth.action_failed": "Action failed",
  ...
  "game.categories.decades": "Decades",
  "game.categories.female": "Female Artists",
  "game.categories.other": "Other Categories",
  ...
  "game.chronology.feedback.title": "Round Feedback",
  "game.chronology.feedback.continue": "Continue",
  "game.chronology.feedback.close": "Close",
  ...
  "game.end.restartSameGameHelp": "Start the same category and difficulty again for a new round",
  ...
  "game.filter.label": "Filter by category:",
  "game.filter.all": "All Categories",
  "game.filter.decades": "Decades",
  "game.filter.female": "Female Artists",
  "game.filter.classic-rock": "Classic Rock & Hard Rock",
  "game.filter.metal-classic": "Metal – Classics",
  ...
  "game.filter.global-pop": "Global Pop Scenes",
  ...
  "game.filter.caribbean-afro": "Caribbean & Afro",
  "game.filter.folk-regional": "Folk & Regional",
  "game.filter.classical-orchestral": "Classical & Orchestral",
  "game.filter.countries-regional": "Countries & Regional",
  "game.filter.emotional": "Emotional Genres",
  "game.filter.seasonal": "Seasonal Genres",
  "game.filter.situational": "Situational & Activity-Based",
  "game.filter.other": "Other Categories",
  ...
  "game.loading.questions": "Loading questions...",
  ...
  "nav.menu.highscores.desc": "View leaderboards and rankings",
  ...
  "nav.podcasts.description": "Listen to music podcasts and read transcripts",
  ...
  "podcast.rss.description":
    "MelodyMind is your audio guide through music history: compelling storytelling, curated listening examples, and background on artists, genres, and eras—from the 1950s to today. Each episode brings context, aha moments, and reliable sources so you don’t just hear music—you understand it.",
  ...
  "podcast.search.placeholder": "Search podcasts...",
  "podcast.search.reset.text": "Reset Search",
  "podcasts.title": "Podcasts",
  "podcasts.cover_alt": "Cover image for",
  ...
  "podcasts.player.accessibility.title": "🎙️ Accessible Podcast Player",
  "podcasts.player.features.auto_scroll": "Auto-scroll",
  "podcasts.player.features.auto_scroll_desc": "Transcript automatically follows audio",
  "podcasts.player.features.clickable": "Clickable segments",
  "podcasts.player.features.clickable_desc": "Click any text to jump to that position",
  "podcasts.player.features.speakers": "Speaker identification",
  "podcasts.player.features.speakers_desc": "Visual distinction between speakers",
  "podcasts.player.features.keyboard": "Keyboard navigation",
  "podcasts.player.features.keyboard_desc": "Full keyboard control support",
  "podcasts.player.features.screen_reader": "Screen reader",
  "podcasts.player.features.screen_reader_desc": "Optimized for assistive technologies",
  "podcasts.player.audio.title": "Audio Player",
  "podcasts.player.captions": "Captions",
  "podcasts.player.descriptions": "Audio descriptions",
  "podcasts.player.not_supported": "Your browser does not support the audio element.",
  "podcasts.player.controls.load_transcript": "Load Transcript",
  "podcasts.player.controls.auto_scroll": "Auto-Scroll",
  "podcasts.player.controls.on": "On",
  "podcasts.player.controls.to_start": "To Start",
  "podcasts.player.controls.to_start_desc": "Jump to the beginning of the audio",
  "podcasts.player.transcript.title": "Podcast Transcript",
  "podcasts.player.transcript.placeholder": "No transcript content available yet.",
  "podcasts.transcript.toggle": "Toggle transcript",
  "podcasts.transcript.show": "Show Transcript",
  "podcasts.transcript.title": "Episode Transcript",
  "podcasts.transcript.info": "Click on any segment to jump to that position in the audio.",
  "podcasts.transcript.loading": "Click to load transcript...",
  "podcasts.player.shortcuts.title": "Keyboard Shortcuts",
  "podcasts.player.shortcuts.play_pause": "Play/Pause",
  "podcasts.player.shortcuts.seek": "10 seconds back/forward",
  "podcasts.player.shortcuts.volume": "Volume up/down",
  "podcasts.player.shortcuts.jump": "Jump to selected segment",
  ...
  "podcasts.language_restriction.description":
    "Our podcast episodes are currently available only in German and English. Please switch to one of these languages to discover our content.",
  ...
  "profile.oauth_accounts.title": "Connected Accounts",
  "profile.desc": "Manage your personal information and game statistics",
  ...
  "news.articlesList": "Articles list",
  "news.readMore": "Read more",
  "news.relevanceScore": "Relevance",
  "news.noNews": "No news available",
  "news.noNewsDescription": "No music news is currently available. Please try again later.",
