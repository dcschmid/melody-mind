export default {
  ...
  "notice.fallback_content": "Fallback inhoud beschikbaar",
  "playlist.accessibility.info": "Playlist toegankelijkheidsinformatie",
  "playlist.accessibility.public":
    "Openbare playlist - geen authenticatie vereist voor streaming service toegang",
  "playlist.item.coming.soon": "Binnenkort beschikbaar",
  "playlist.item.status": "Status",
  "playlist.item.status.changed.available": "Deze playlist is nu beschikbaar om te spelen",
  "playlist.item.status.changed.disabled": "Deze playlist is momenteel niet beschikbaar",
  "playlist.item.unavailable": "Deze inhoud is nog niet beschikbaar",
  "playlist.no.results": "Geen overeenkomende playlists gevonden. Probeer een andere zoekterm.",
  "playlist.no.results.heading": "Geen playlists gevonden",
  "playlist.page.description":
    "🎵 Begin aan een epische muzikale reis door legendarische tijdperken! Onze handgekozen playlists brengen de grootste hits tot leven - van tijdloze klassiekers tot onvergetelijke hitparadetoppers. Perfect voor het uitbreiden van je muziekkennis of het opwekken van nostalgische herinneringen! 🎶",
  "playlist.page.heading": "Ontdek Onze Muziek Playlists",
  "playlist.reset.search": "Alle playlists tonen",
  "playlist.search.aria.label": "Zoek muziek playlists",
  "playlist.search.heading": "Zoek Playlists",
  ...
  "share.accessibility.copy_failed_manual":
    "Kopiëren mislukt. Kopieer handmatig de pagina URL uit je browser.",
  ...
  "share.accessibility.data_still_unavailable":
    "Spelgegevens nog steeds niet beschikbaar. Probeer de pagina te verversen of gebruik handmatig kopiëren.",
  ...
  "share.accessibility.link_copied_fallback":
    "Spellink gekopieerd naar klembord met fallback methode!",
  ...
  "share.accessibility.retry_failed":
    "Opnieuw proberen mislukt. Probeer handmatig kopiëren of ververs de pagina.",
  "share.accessibility.retrying": "Opnieuw proberen spelgegevens te vinden...",
  "share.accessibility.score_copied": "Score succesvol gekopieerd naar klembord!",
  "share.accessibility.score_shared": "Je score succesvol gedeeld.",
  "share.accessibility.sharing_cancelled": "Delen geannuleerd.",
  "share.accessibility.try_alternative_methods":
    "Probeer naar klembord kopiëren of een andere deelmethode te gebruiken.",
  "share.accessibility.try_platform_buttons":
    "Probeer de platform-specifieke deel knoppen te gebruiken of kopieer naar klembord",
  "share.buttons.group.label": "Sociale Media Deel Opties",
  ...
  "share.fallback.manual.text": "Link Kopiëren",
  ...
  "share.fallback.retry.label": "Opnieuw laden van spelgegevens proberen",
  ...
  "toc.toggle.label": "Inhoudsopgave omschakelen",
};
