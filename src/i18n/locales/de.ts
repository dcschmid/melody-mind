export default {
  ...
  "achievements.points": "{points} Punkte",
  ...
  "category.filter.aria_label": "Filter nach Kategorie",
  "category.filter.option_all": "Alle Kategorien",
  ...
  "auth.guest.benefit.leaderboard": "An Bestenlisten teilnehmen",
  "auth.guest.benefit.stats": "Detaillierte Statistiken verfolgen",
  "auth.guest.or": "oder",
  ...
  "auth.oauth.continue_with": "Weiter mit",
  "auth.oauth.link_accounts": "Verknüpfen Sie Ihre Konten",
  "auth.oauth.already_linked": "Bereits verknüpft",
  "auth.oauth.loading_providers": "Authentifizierungsanbieter werden geladen...",
  "auth.oauth.providers_error": "Fehler beim Laden der Authentifizierungsanbieter",
  "auth.oauth.no_providers": "Keine Authentifizierungsanbieter verfügbar",
  "auth.oauth.retry": "Erneut versuchen",
  "auth.oauth.invalid_provider": "Ungültiger Authentifizierungsanbieter",
  "auth.oauth.invalid_callback": "Ungültiger Authentifizierungs-Callback",
  "auth.oauth.provider_error": "Authentifizierungsanbieter-Fehler",
  "auth.oauth.authorization_failed": "Autorisierung fehlgeschlagen",
  "auth.oauth.callback_failed": "Authentifizierungs-Callback fehlgeschlagen",
  "auth.oauth.providers_failed": "Fehler beim Laden der Anbieter",
  "auth.oauth.unlink_success": "{provider}-Konto erfolgreich getrennt",
  "auth.oauth.unlink_failed": "Fehler beim Trennen des {provider}-Kontos",
  "auth.oauth.provider_not_linked": "Dieser Anbieter ist nicht mit Ihrem Konto verknüpft",
  "auth.oauth.linked_accounts": "Verknüpfte Konten",
  "auth.oauth.linked_accounts_description": "Verwalten Sie Ihre verknüpften Social-Media-Konten",
  "auth.oauth.spotify.description": "Verknüpfen Sie Ihr Spotify-Konto",
  "auth.oauth.google.description": "Verknüpfen Sie Ihr Google-Konto",
  "auth.oauth.apple.description": "Verknüpfen Sie Ihre Apple-ID",
  "auth.oauth.discord.description": "Verknüpfen Sie Ihr Discord-Konto",
  "auth.oauth.yahoo.description": "Verknüpfen Sie Ihr Yahoo-Konto",
  "auth.oauth.linked": "Verknüpft",
  "auth.oauth.not_linked": "Nicht verknüpft",
  "auth.oauth.link": "Verknüpfen",
  "auth.oauth.unlink": "Trennen",
  "auth.oauth.link_provider": "{{provider}} verknüpfen",
  "auth.oauth.unlink_provider": "{{provider}} trennen",
  "auth.oauth.unlink_confirm_title": "Konto trennen",
  ...
  "game.categories.decades": "Jahrzehnte",
  "game.categories.female": "Weibliche Künstler",
  "game.categories.other": "Andere Kategorien",
  ...
  "game.chronology.feedback.title": "Runden-Feedback",
  "game.chronology.feedback.continue": "Weiter",
  "game.chronology.feedback.close": "Schließen",
  ...
  "game.filter.label": "Nach Kategorie filtern:",
  "game.filter.all": "Alle Kategorien",
  "game.filter.decades": "Jahrzehnte",
  "game.filter.female": "Weibliche Künstler",
  "game.filter.classic-rock": "Klassischer Rock & Hard Rock",
  "game.filter.metal-classic": "Metal – Klassiker",
  "game.filter.metal-modern": "Modern Metal",
  "game.filter.metal-avantgarde": "Avantgarde & Extreme Metal",
  "game.filter.mainstream-pop": "Mainstream Pop",
  "game.filter.indie-alternative": "Indie & Alternative",
  "game.filter.global-pop": "Globale Pop-Szenen",
  "game.filter.jazz-soul-funk": "Jazz, Soul & Funk",
  "game.filter.hip-hop-rap": "Hip Hop & Rap",
  "game.filter.house-techno": "House & Techno",
  "game.filter.club-sounds": "Club Sounds",
  "game.filter.breaks-experimental": "Breaks & Experimental",
  "game.filter.latin-vibes": "Latin Vibes",
  "game.filter.caribbean-afro": "Karibik & Afro",
  "game.filter.folk-regional": "Folk & Regional",
  "game.filter.classical-orchestral": "Klassik & Orchester",
  "game.filter.countries-regional": "Länder & Regionale Genres",
  "game.filter.emotional": "Emotionale Genres",
  "game.filter.seasonal": "Saisonale Genres",
  "game.filter.situational": "Situations- & Aktivitätsbasierte Genres",
  "game.filter.other": "Andere Kategorien",
  ...
  "game.timepressure.countdown": "Countdown-Timer",
  "game.timepressure.skip": "Überspringen",
  "game.loading": "Laden",
  "game.loading.questions": "Lade Fragen...",
  ...
  "knowledge.section.description":
    "Tauche tiefer in die Geschichte und Hintergründe dieser Musikrichtung ein.",
  "knowledge.read.more": "Mehr erfahren",
  ...
  "musicPlatforms.description":
    "Entdecke kuratierte Playlists auf deinen bevorzugten Streaming-Plattformen.",
  ...
  "nav.donate.description": "Unterstützen Sie unser Projekt mit einer Spende",
  "nav.donate.heading": "Unterstützen Sie uns",
  "nav.donate.paypal": "Spenden über PayPal",
  "nav.highscores.description": "Die besten Ergebnisse und Ranglisten anzeigen",
  "nav.home": "Startseite",
  "nav.home.description": "Zur Hauptseite zurückkehren",
  "nav.knowledge.description": "Musikwissen und Trivia erkunden",
  "nav.logout.description": "Aus Ihrem Konto abmelden",
  "nav.logout.label": "Aus der Anwendung abmelden",
  "nav.menu.close": "Menü schließen",
  "nav.menu.highscores": "Bestenliste",
  "nav.menu.highscores.desc": "Leaderboards und Ranglisten ansehen",
  "nav.menu.home": "Startseite",
  "nav.menu.home.desc": "Zur Hauptseite zurückkehren",
  "nav.menu.logout": "Abmelden",
  "nav.menu.logout.desc": "Von Ihrem Konto abmelden",
  "nav.menu.guest.exit": "Gastmodus verlassen",
  "nav.menu.guest.exit.desc": "Zurück zum Anmeldebildschirm",
  "nav.menu.open": "Menü öffnen",
  "nav.menu.knowledge": "Wissensdatenbank",
  "nav.menu.knowledge.desc": "Musikwissen und Trivia erkunden",
  "nav.menu.playlists": "Playlists",
  "nav.menu.playlists.desc": "Kuratierte Musik-Playlists entdecken",
  "nav.menu.achievements": "Erfolge",
  "nav.menu.achievements.desc": "Ihre freigeschalteten Erfolge und Fortschritte anzeigen",
  "nav.menu.profile.desc": "Ihr Profil und Einstellungen verwalten",
  "nav.menu.podcasts": "Podcasts",
  "nav.menu.rules": "Spielregeln",
  "nav.menu.text": "Menü",
  "nav.openNewWindow": "Öffnet in neuem Fenster",
  "nav.playlists.description": "Kuratierte Musik-Playlists entdecken",
  "nav.podcasts.description": "Musikpodcasts anhören und Transkripte lesen",
  "nav.profile.description": "Ihr Profil und Einstellungen verwalten",
  // Section titles for the new navigation overlay
  "nav.section.account": "Konto",
  "nav.section.compete": "Antreten",
  "nav.section.discover": "Entdecken",
  "nav.section.main": "Hauptbereich",
  "nav.section.support": "Unterstützung",
  // Navigation subtitle
  "nav.subtitle": "Musik entdecken, mit Freunden konkurrieren und Ihr Wissen testen",
  "nav.skip.main": "Zum Hauptinhalt springen",
  "nav.title": "Navigation",
  // Legacy section keys for compatibility
  "nav.sections.account": "Konto",
  "nav.sections.compete": "Antreten",
  "nav.sections.discover": "Entdecken",
  "nav.sections.main": "Hauptbereich",
  "nav.sections.support": "Unterstützung",
  ...
  "podcast.search.placeholder": "Podcasts suchen...",
  "podcast.search.reset.text": "Suche zurücksetzen",
  "podcasts.title": "Podcasts",
  "podcasts.cover_alt": "Cover-Bild für",
  "podcasts.category": "Kategorie",
  "podcasts.duration": "Dauer",
  ...
  "podcasts.player.accessibility.title": "🎙️ Barrierefreier Podcast-Player",
  "podcasts.player.features.auto_scroll": "Auto-Scroll",
  "podcasts.player.features.auto_scroll_desc": "Transkript folgt automatisch dem Audio",
  "podcasts.player.features.clickable": "Klickbare Segmente",
  "podcasts.player.features.clickable_desc":
    "Klicken Sie auf beliebigen Text, um zu dieser Position zu springen",
  "podcasts.player.features.speakers": "Sprecher-Identifikation",
  "podcasts.player.features.speakers_desc": "Visuelle Unterscheidung zwischen Sprechern",
  "podcasts.player.features.keyboard": "Tastaturnavigation",
  "podcasts.player.features.keyboard_desc": "Vollständige Tastatursteuerung",
  "podcasts.player.features.screen_reader": "Bildschirmleser",
  "podcasts.player.features.screen_reader_desc": "Optimiert für assistive Technologien",
  "podcasts.player.audio.title": "Audio-Player",
  "podcasts.player.captions": "Untertitel",
  "podcasts.player.descriptions": "Audio-Beschreibungen",
  "podcasts.player.not_supported": "Ihr Browser unterstützt das Audio-Element nicht.",
  "podcasts.player.controls.load_transcript": "Transkript laden",
  "podcasts.player.controls.auto_scroll": "Auto-Scroll",
  "podcasts.player.controls.on": "Ein",
  "podcasts.player.controls.to_start": "Zum Anfang",
  "podcasts.player.controls.to_start_desc": "Zum Anfang des Audios springen",
  "podcasts.player.transcript.title": "Podcast-Transkript",
  "podcasts.transcript.toggle": "Transkript umschalten",
  "podcasts.transcript.show": "Transkript anzeigen",
  "podcasts.transcript.title": "Episoden-Transkript",
  "podcasts.transcript.info":
    "Klicken Sie auf ein beliebiges Segment, um zu dieser Position im Audio zu springen.",
  "podcasts.transcript.loading": "Klicken Sie, um das Transkript zu laden...",
  "podcasts.player.transcript.placeholder": "Noch kein Transkript-Inhalt verfügbar.",
  "podcasts.player.shortcuts.title": "Tastaturkürzel",
  "podcasts.player.shortcuts.play_pause": "Abspielen/Pausieren",
  "podcasts.player.shortcuts.seek": "10 Sekunden zurück/vorwärts",
  "podcasts.player.shortcuts.volume": "Lautstärke hoch/runter",
  "podcasts.player.shortcuts.jump": "Zu ausgewähltem Segment springen",
  ...
  "profile.stats.timePressure": "Zeitdruck",
  ...
  "profile.oauth_accounts.title": "Verknüpfte Konten",
  "profile.desc": "Verwalten Sie Ihre persönlichen Informationen und Spielstatistiken",
  ...
  "share.achievement.enthusiast": "🎸 Musik‑Enthusiast! 🎸",
  "share.achievement.lover": "🎹 Musik‑Liebhaber! 🎹",
  "share.achievement.explorer": "🎼 Musik‑Entdecker! 🎼",
