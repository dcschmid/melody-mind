export default {
  ...
  "playlist.accessibility.public":
    "Offentlig spellista - ingen autentisering krävs för åtkomst till streamingtjänst",
  "playlist.item.coming.soon": "Kommer snart",
  "playlist.item.status": "Status",
  "playlist.item.status.changed.available": "Denna spellista är nu tillgänglig för uppspelning",
  "playlist.item.status.changed.disabled": "Denna spellista är för närvarande otillgänglig",
  "playlist.item.unavailable": "Detta innehåll är inte tillgängligt ännu",
  ...
  "playlist.page.description":
    "🎵 Ge dig ut på en episk musikalisk resa genom legendariska epoker! Våra handvalda spellistor väcker de största hitsen till liv - från tidlösa klassiker till oförglömliga topplåtar. Perfekt för att utvidga dina musikkunskaper eller väcka nostalgiska minnen! 🎶",
  ...
  "profile.auth.required": "Du måste vara inloggad för att visa din profil",
  "profile.description": "Hantera din personliga information och visa din spelstatistik",
  ...
  "profile.stats.total_score": "Totalpoäng",
  ...
  "session.timeout.warning": "Din session kommer att upphöra om {0} sekunder.",
  ...
  "share.accessibility.data_still_unavailable":
    "Speldata fortfarande otillgänglig. Försök uppdatera sidan eller använd manuell kopiering.",
  "share.accessibility.data_unavailable":
    "Speldata otillgänglig. Vänligen försök igen eller kopiera manuellt.",
  ...
  "share.accessibility.platform_opened": "Öppnade {platform}-delning framgångsrikt.",
  ...
  "share.accessibility.retry_failed":
    "Återförsök misslyckades. Vänligen försök manuell kopiering eller uppdatera sidan.",
  ...
  "share.accessibility.score_shared": "Delade din poäng framgångsrikt.",
  "share.accessibility.sharing_cancelled": "Delning avbruten.",
  ...
  "share.accessibility.try_platform_buttons":
    "Försök använda plattformsspecifika delningsknappar eller kopiera till urklipp istället",
  ...
  "share.fallback.message":
    "Speldata är för närvarande otillgänglig. Vänligen försök igen eller kopiera sidlänken manuellt.",
  ...
  "toc.state.collapsed": "Kollapsad",
  "toc.state.expanded": "Expanderad",
