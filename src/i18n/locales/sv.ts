export default {
  ...
  "auth.login.remember": "För"errors.invalidRequest": "Ogiltig förfrågan: {error}",
  "errors.invalidParameters": "Ogiltiga parametrar angivna",
  "errors.api.invalidLanguage": "Ogiltig språkparameter",
  "errors.achievements.check": "Fel vid kontroll av prestationer. Försök igen senare", inloggad",
