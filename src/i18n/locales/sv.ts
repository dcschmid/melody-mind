export default {
  ...
  "daily.challenge.subtitle": "En kategori, tre sätt att spela — kom tillbaka varje dag!",
  "daily.challenge.date": "Idag: {date}",
  ...
  "daily.streak.label": "Svit",
  "daily.played.today": "Du har redan spelat dagens utmaning.",
  ...
  "toc.state.collapsed": "Minimerad",
  "toc.state.expanded": "Expanderad",
  "toc.toggle.label": "Växla innehållsförteckning",
  "knowledge.section.title": "Läs mer",
  "knowledge.section.description": "Fördjupa dig i ämnet med en fördjupande artikel",
  ...
  "login.description":
    "🎵 Dyk in i det ultimata musikuniversumet! Upptäck legendariska hits, bemästra spännande utmaningar och bli en sann musikmästare. Din resa mot musikens största hemligheter börjar nu! 🚀",
  ...
  "musicPlatforms.externalNotice":
    "Externa musikplattformar kan kräva konto eller prenumeration för full åtkomst.",
  "musicPlatforms.heading": "Lyssna på relaterad musik",
  "musicPlatforms.keyboardInstructions":
    "Navigera mellan musikplattformar med Tab. Tryck Enter eller Mellanslag för att öppna i nya flikar.",
