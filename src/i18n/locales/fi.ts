export default {
  ...
  "nav.subtitle": "Löydä musiikkia, taistele ystävien kanssa ja testaa tietosi",
  ...
  "errors.gameResult.database.saveFailed": "Pelin tuloksen tallennus epäonnistui",
  ...
  "game.end.defaultMotivation": "Hienoa! Jatka pelaamista parantaaksesi pistemäärääsi!",
  ...
  "game.feedback.next.starting": "Seuraava kierros käynnistyy",
  ...
  "game.genre.selection.description":
    "Valitse useista musiikkityyleistä kuten rock, pop, jazz, klassinen ja lisää. Jokaisessa kategoriassa on huolellisesti valitut kysymykset testaamaan musiikkitaitoasi.",
  ...
  "highscores.seo.description":
    "Katso parhaat musiikkivisan tulokset ja kilpaile muiden pelaajien kanssa",
  ...
  "knowledge.play.description":
    "🎵 Valmiina viimeiseen haasteeseen? Testaa musiikkitietosi ja tule genreasiantuntijaksi! Kerää pisteitä, käytä älykkäitä jokereita ja näytä että sinussa on mestarin aineksia! 🏆",
  ...
  "playlist.page.description":
    "🎵 Lähde eeppiselle musiikkimatkalle eri aikakausien läpi! Käsin valitut soittolistamme herättävät suuret hitit eloon - aina ajattomista klassikoista unohtumattomiin listahitteihin. Täydellinen tapa laajentaa musiikkitietämystäsi tai herättää nostalgia! 🎶",
  ...
  "knowledge.section.description": "Syvenny aiheeseen kattavien artikkeleiden avulla",
