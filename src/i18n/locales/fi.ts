export default {
  ...
  "game.timepressure.description": "Pelaa aikarajoitusten alla sekoitetuilla vaikeusasteilla kategoriassa {category}",
  ...
  "nav.menu.dailyFacts": "Päivittäiset faktat",
  "nav.menu.dailyFacts.desc": "Löydä uusia musiikkifaktoja joka päivä",
