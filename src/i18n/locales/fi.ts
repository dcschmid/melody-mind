export default {
  ...
  // Extra keys present in the original fi.ts but not in the explicit/template-based file.
  // These are preserved here to avoid losing translations or app-specific keys.
  "search.articles": "Etsi artikkeleita",
  "search.findArticles": "Löydä artikkeleita otsikon, kuvauksen tai avainsanojen mukaan",
  "search.byTitleOrDescription": "Etsi otsikon tai kuvauksen perusteella",
  "search.placeholder": "Etsi artikkeleita...",
  "search.reset": "Palauta",
  ...
  "common.share": "Jaa",
  "auto.src.pages.404.don_t_worry_though_there_s": "Don't worry though, there's plenty of music to discover! Try one of the options below to get back on track.",
  "footer.description": "Täydellinen musiikkitietovisa. Testaa tietosi eri genreistä ja vuosikymmenistä.",
