export default {
  ...
  "playlist.accessibility.public":
    "Playlist publique - aucune authentification requise pour l'accès au service de streaming",
  "playlist.item.coming.soon": "Bientôt disponible",
  "playlist.item.status": "Statut",
  "playlist.item.status.changed.available": "Cette playlist est maintenant disponible pour jouer",
  "playlist.item.status.changed.disabled": "Cette playlist est actuellement indisponible",
  ...
  "playlist.page.description":
    "🎵 Embarquez pour un voyage musical épique à travers les époques légendaires ! Nos playlists sélectionnées donnent vie aux plus grands hits - des classiques intemporels aux tubes inoubliables. Parfait pour élargir vos connaissances musicales ou réveiller des souvenirs nostalgiques ! 🎶",
  ...
  "profile.stats.highest_score": "Score le plus élevé",
  ...
  "share.accessibility.copy_failed_manual":
    "Échec de la copie. Veuillez copier manuellement l'URL de la page depuis votre navigateur.",
  ...
  "share.accessibility.data_still_unavailable":
    "Données de jeu toujours indisponibles. Essayez d'actualiser la page ou utilisez la copie manuelle.",
  ...
  "share.accessibility.native_share_failed":
    "Échec du partage natif : {errorMessage}. {recoveryMessage}",
  "share.accessibility.platform_opened": "Ouverture du partage {platform} réussie.",
  ...
  "share.accessibility.retry_failed":
    "Échec de la nouvelle tentative. Veuillez essayer la copie manuelle ou actualiser la page.",
  "share.accessibility.retrying": "Nouvelle tentative pour trouver les données de jeu...",
  ...
  "share.accessibility.try_platform_buttons":
    "Essayez d'utiliser les boutons de partage spécifiques à la plateforme ou copiez dans le presse-papiers à la place",
  ...
  "share.fallback.manual.label": "Copier manuellement le lien de la page",
  "share.fallback.manual.text": "Copier le lien",
  "share.fallback.message":
    "Les données de jeu sont actuellement indisponibles. Veuillez réessayer ou copier manuellement le lien de la page.",
  "share.fallback.retry.label": "Réessayer de charger les données de jeu",
