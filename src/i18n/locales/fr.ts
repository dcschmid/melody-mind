export default {
  ...
  "game.timepressure.description": "Jouez sous contraintes de temps avec des niveaux de difficulté mixtes dans {category}",
  ...
  "nav.menu.dailyFacts": "Faits Quotidiens",
  "nav.menu.dailyFacts.desc": "Découvrir de nouveaux faits musicaux quotidiennement",
