export default {
  ...
  "notice.fallback_content": "Reserveindhold tilgængeligt",
  "playlist.accessibility.info": "Spilleliste tilgængelighedsinfo",
  "playlist.accessibility.public":
    "Offentlig spilleliste - ingen autentificering krævet for streaming-tjeneste adgang",
  "playlist.item.coming.soon": "Kommer snart",
  "playlist.item.status": "Status",
  "playlist.item.status.changed.available": "Denne spilleliste er nu tilgængelig for afspilning",
  "playlist.item.status.changed.disabled": "Denne spilleliste er i øjeblikket utilgængelig",
  "playlist.item.unavailable": "Dette indhold er endnu ikke tilgængeligt",
  "playlist.no.results": "Ingen matchende spillelister fundet. Prøv et andet søgeord.",
  "playlist.no.results.heading": "Ingen spillelister fundet",
  "playlist.page.description":
    "🎵 Begiv dig ud på en episk musikalsk rejse gennem legendariske epoker! Vores håndplukkede spillelister bringer de største hits til live - fra tidløse klassikere til uforglemmelige chart-toppers. Perfekt til at udvide din musikviden eller vække nostalgiske minder! 🎶",
  "playlist.page.heading": "Opdag vores musik spillelister",
  "playlist.reset.search": "Vis alle spillelister",
  "playlist.search.aria.label": "Søg musik spillelister",
  "playlist.search.heading": "Søg spillelister",
  ...
  "profile.recent_games.title": "Nylige spil",
  ...
  "share.copy": "Kopier tekst til at dele til udklipsholder",
  "share.copy.label": "Kopier tekst",
  "share.email": "Del via e-mail",
  "share.email.label": "E-mail",
  "share.fallback.manual.label": "Kopier side-link manuelt",
  "share.fallback.manual.text": "Kopier link",
  "share.fallback.message":
    "Spildata er i øjeblikket utilgængelig. Prøv igen eller kopier side-linket manuelt.",
  "share.fallback.retry.label": "Prøv igen at indlæse spildata",
