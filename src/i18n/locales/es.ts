export default {
  ...
  "podcasts.language_restriction.description": "Nuestros episodios de podcast están disponibles actualmente solo en alemán e inglés. Por favor, cambie a uno de estos idiomas para descubrir nuestro contenido.",
