export default {
  ...
  "game.answer.wrong": "¡Fallaste! La respuesta correcta fue: {answer}",
  "game.area.label": "Área de juego",
  "game.categories.empty.headline": "No se encontraron géneros",
  "game.categories.empty.text":
    "Desafortunadamente, no se encontraron categorías. Inténtalo más tarde.",
  ...
  "game.genre.selection.description":
    "Elige entre múltiples géneros: rock, pop, jazz, clásica y más. Cada categoría tiene preguntas seleccionadas para poner a prueba tu conocimiento musical.",
  ...
  "knowledge.play.description":
    "🎵 ¿Listo para el desafío definitivo? Pon a prueba tu conocimiento musical y conviértete en experto de un género. ¡Gana puntos, usa jokers inteligentes y demuestra que tienes lo que hace falta para ser un campeón! 🏆",
  ...
  "playlist.page.description":
    "🎵 Emprende un épico viaje musical a través de eras legendarias. Nuestras listas seleccionadas traen los mayores éxitos a la vida — desde clásicos atemporales hasta éxitos inolvidables. ¡Perfecto para ampliar tu conocimiento musical o despertar la nostalgia! 🎶",
  ...
  "profile.description": "Administra tu información y consulta tus estadísticas de juego",
  ...
  "share.score_line":
    "He conseguido {score} puntos en el quiz {category} de Melody Mind ({difficulty})!",
  ...
  "knowledge.section.description": "Profundiza en este tema con artículos completos",
