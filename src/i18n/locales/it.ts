export default {
  ...
  "auth.password.requirements.status": "{{met}} di {{total}} requisiti soddisfatti",
  "auth.password.requirements.help":
    "La tua password deve soddisfare tutti i requisiti elencati di seguito per la sicurezza",
  "auth.password.requirements.checklist": "Lista di controllo requisiti password",
  ...
  "auth.password.strength.description": "Indicatore del livello di sicurezza della password",
  ...
  // Chiavi aggiuntive del gioco di cronologia
  "game.chronology.meta.description": "Gioco di Cronologia Musicale:",
  ...
  "game.difficulty.label": "Livello di difficoltà",
  "game.coins.label": "Monete raccolte",
  "game.player.title": "Titolo del giocatore",
  "game.chronology.touch.navigation": "Navigazione touch",
