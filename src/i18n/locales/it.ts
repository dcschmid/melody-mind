export default {
  ...
  "accessibility.skip.to.content": "Passa al contenuto principale",
  ...
  // Lingue
  "language.picker.label": "Selettore di lingua",
  ...
  "language.selected": "Lingua attuale: {language}",
  "language.dropdown.arrow": "Freccia a discesa",
  "language.focus.announce": "Selettore di lingua attivato. Usa i tasti freccia per navigare.",
  ...
  "achievements.nav.aria": "Navigazione ai traguardi",
  "achievements.nav.link": "Vai ai traguardi",
  ...
  "nav.donate.heading": "Supporta",
  "nav.donate.paypal": "PayPal",
  "nav.openNewWindow": "Si apre in una nuova finestra",
  "nav.donate.coffee": "Offrimi un caffè",
  "nav.menu.opened": "aperto",
  "nav.menu.closed": "chiuso",
  "nav.menu.moved_to_first": "Spostato al primo elemento del menu",
