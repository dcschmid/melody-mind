export default {
  ...
  "playlist.accessibility.info": "Informazioni accessibilità playlist",
  "playlist.accessibility.public":
    "Playlist pubblica - nessuna autenticazione richiesta per l'accesso al servizio streaming",
  ...
  "playlist.no.results":
    "Nessuna playlist trovata corrispondente. Prova un termine di ricerca diverso.",
  "playlist.no.results.heading": "Nessuna playlist trovata",
  "playlist.page.description":
    "🎵 Intraprendi un viaggio musicale epico attraverso ere leggendarie! Le nostre playlist selezionate danno vita ai più grandi successi - dai classici senza tempo ai chart-topper indimenticabili. Perfetto per espandere la tua conoscenza musicale o risvegliare ricordi nostalgici! 🎶",
  ...
  "profile.auth.required": "Devi essere autenticato per visualizzare il tuo profilo",
  "profile.description":
  ...
  "share.accessibility.copy_failed_manual":
    "Copia fallita. Copia manualmente l'URL della pagina dal tuo browser.",
  ...
  "share.accessibility.link_copied_fallback":
    "Link di gioco copiato negli appunti usando metodo di fallback!",
  "share.accessibility.native_share_failed":
    "Condivisione nativa fallita: {errorMessage}. {recoveryMessage}",
  "share.accessibility.platform_opened": "Aperta condivisione {platform} con successo.",
  "share.accessibility.platform_share_failed":
    "Impossibile condividere su {platform}: {errorMessage}. {recoveryMessage}",
  "share.accessibility.retry_failed":
    "Riprova fallita. Prova la copia manuale o aggiorna la pagina.",
  "share.accessibility.retrying": "Riprovando a trovare i dati di gioco...",
  ...
  "share.accessibility.try_platform_buttons":
    "Prova a usare i pulsanti di condivisione specifici della piattaforma o copia negli appunti invece",
  "share.buttons.group.label": "Opzioni di Condivisione Social Media",
  "share.copy": "Copia testo da condividere negli appunti",
  "share.copy.label": "Copia Testo",
  "share.email": "Condividi via Email",
  "share.email.label": "Email",
  "share.fallback.manual.label": "Copia link pagina manualmente",
  "share.fallback.manual.text": "Copia Link",
  "share.fallback.message":
    "I dati di gioco sono attualmente non disponibili. Riprova o copia il link della pagina manualmente.",
  "share.fallback.retry.label": "Riprova caricamento dati di gioco",
  ...
  "toc.toggle.label": "Attiva/disattiva indice dei contenuti",
};
