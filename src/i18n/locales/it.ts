export default {
  ...
  "game.timepressure.description": "Gioca sotto vincoli di tempo con livelli di difficoltà misti in {category}",
  ...
  "nav.menu.dailyFacts": "Fatti Giornalieri",
  "nav.menu.dailyFacts.desc": "Scopri nuovi fatti musicali giornalmente",
  ...
  "dailyFacts.title": "Oggi nella Storia della Musica",
  "dailyFacts.subtitle": "Scopri nuovi fatti musicali ogni giorno",
  "dailyFacts.noFactAvailable": "Nessun fatto musicale disponibile oggi",
  "dailyFacts.share": "Condividi fatto",
  "dailyFacts.artist": "Artista",
  "dailyFacts.album": "Album",
  "dailyFacts.genre": "Genere",
  "dailyFacts.archive.title": "Sfoglia Tutti i Fatti",
  "dailyFacts.archive.subtitle": "Cerca tutti i fatti musicali per data e categoria",
  "dailyFacts.thisMonth": "Questo Mese",
  "dailyFacts.randomFact": "Fatto Musicale Casuale",
  "dailyFacts.loadNewFact": "Carica Nuovo Fatto",
  "dailyFacts.categories": "Categorie",
  "dailyFacts.categories.birth": "Nascita",
  "dailyFacts.categories.death": "Morte",
  "dailyFacts.categories.release": "Pubblicazione",
  "dailyFacts.categories.event": "Evento",
  "dailyFacts.categories.milestone": "Traguardo",
  "dailyFacts.categories.formation": "Formazione",
  "dailyFacts.categories.breakthrough": "Successo",
};
