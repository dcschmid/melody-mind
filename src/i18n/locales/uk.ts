export default {
  ...
  "auth.form.instructions.request.step1": "Введіть свою електронну адресу в поле нижче",
  ...
  "notice.fallback_content": "Резервний контент доступний",
  "playlist.accessibility.info": "Інформація про доступність плейлиста",
  "playlist.accessibility.public":
    "Публічний плейлист - не потрібна автентифікація для доступу до стрімінгового сервісу",
  "playlist.item.coming.soon": "Скоро з'явиться",
  "playlist.item.status": "Статус",
  "playlist.item.status.changed.available": "Цей плейлист тепер доступний для відтворення",
  "playlist.item.status.changed.disabled": "Цей плейлист наразі недоступний",
  "playlist.item.unavailable": "Цей контент поки що недоступний",
  "playlist.no.results": "Не знайдено відповідних плейлистів. Спробуйте інший пошуковий термін.",
  "playlist.no.results.heading": "Плейлисти не знайдено",
  "playlist.page.description":
    "🎵 Вирушайте в епічну музичну подорож через легендарні епохи! Наші ретельно підібрані плейлисти оживляють найкращі хіти - від вічної класики до незабутніх чарт-топерів. Ідеально підходить для розширення ваших музичних знань або пробудження ностальгічних спогадів! 🎶",
  "playlist.page.heading": "Відкрийте наші музичні плейлисти",
  ...
  "profile.auth.required": "Ви повинні увійти в систему, щоб переглянути свій профіль",
  "profile.description": "Управляйте особистою інформацією та переглядайте статистику ігор",
  "profile.error": "Помилка завантаження даних профілю",
  ...
  "profile.recent_games.empty": "Немає нещодавніх ігор",
  "profile.recent_games.points": "Очки",
  "profile.recent_games.title": "Нещодавні ігри",
  "profile.stats.chronology": "Хронологія",
  "profile.stats.games_played": "Зіграно ігор",
  "profile.stats.highest_score": "Найвищий рахунок",
  "profile.stats.quiz": "Вікторина",
  "profile.stats.title": "Статистика ігор",
  ...
  "session.timeout.extend": "Продовжити сесію",
  "session.timeout.warning": "Ваша сесія закінчиться через {0} секунд.",
  "share.accessibility.copy_failed_manual":
    "Копіювання не вдалося. Будь ласка, вручну скопіюйте URL сторінки з вашого браузера.",
  "share.accessibility.data_found": "Дані гри знайдено! Тепер доступні опції ділення.",
  "share.accessibility.data_still_unavailable":
    "Дані гри все ще недоступні. Спробуйте оновити сторінку або використовуйте ручне копіювання.",
  ...
  "share.accessibility.native_share_failed":
    "Нативне ділення не вдалося: {errorMessage}. {recoveryMessage}",
  "share.accessibility.platform_opened": "Успішно відкрито ділення {platform}.",
  "share.accessibility.platform_share_failed":
    "Не вдалося поділитися в {platform}: {errorMessage}. {recoveryMessage}",
  "share.accessibility.retry_failed":
    "Повторна спроба не вдалася. Будь ласка, спробуйте ручне копіювання або оновіть сторінку.",
  ...
  "share.accessibility.score_shared": "Успішно поділилися вашим рахунком.",
  "share.accessibility.sharing_cancelled": "Ділення скасовано.",
  "share.accessibility.try_alternative_methods":
    "Спробуйте скопіювати в буфер обміну або використовувати інший метод ділення.",
  "share.accessibility.try_platform_buttons":
    "Спробуйте використовувати кнопки ділення для конкретної платформи або скопіювати в буфер обміну",
  "share.buttons.group.label": "Варіанти ділення в соціальних мережах",
  "share.copy": "Скопіювати текст для ділення в буфер обміну",
  "share.copy.label": "Скопіювати текст",
  "share.email": "Поділитися через електронну пошту",
  "share.email.label": "Електронна пошта",
  "share.fallback.manual.label": "Скопіювати посилання на сторінку вручну",
  "share.fallback.manual.text": "Скопіювати посилання",
  "share.fallback.message":
    "Дані гри наразі недоступні. Будь ласка, спробуйте знову або скопіюйте посилання на сторінку вручну.",
  "share.fallback.retry.label": "Повторити завантаження даних гри",
  "share.fallback.retry.text": "Повторити",
  ...
  "toc.nav.label": "Зміст",
  "toc.skip.link": "Перейти до основного контенту",
