...
export async function loadAlbumsWithFallback(
  ...
  try {
    ...
    console.error(`Failed to load fallback data for ${category}:`, fallbackError);
    throw new Error(`Category '${category}' not found in any language. Available categories might be: 1950s, 1960s, 1970s, 1980s, 1990s, 2000s, 2010s`);
  }
}
