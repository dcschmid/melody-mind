...
export function clearLocalStorageAfterLastRound(category: string) {
    ...
    localStorage.removeItem(`${category}-triviaData-round-one`);
    ...
    localStorage.removeItem(`${category}-triviaData-round-two`);
    ...
    localStorage.removeItem(`${category}-triviaData-round-three`);
