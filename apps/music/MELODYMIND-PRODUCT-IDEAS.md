...
Ein kuratiertes Radio aus dem MelodyMind-Katalog. Jeder Sender besitzt eine klare
redaktionelle Idee und eine nachvollziehbare Auswahlregel.
...
- Office Apocalypse
- Gothic Romance
- Longform Album Radio
- New on MelodyMind

### Kernnutzen

Music eignet sich heute gut für gezielte Albumwahl. Radio ergänzt einen Modus für
Menschen, die sofort hören möchten und nicht zuerst Cover, Genre-Seiten oder
Suchergebnisse vergleichen wollen.

### MVP

- fünf feste Sender
- regelbasierte Auswahl über Genre, Sprache, Stimmung und Energie
- Anzeige der nächsten drei Tracks
- Überspringen
- direkter Wechsel zum Album
- keine Anmeldung
- keine individuelle Empfehlung

### Redaktionelle Übergänge

Zwischen zwei Alben kann eine kurze Einordnung erscheinen:

> You just heard _Velvet Coffin_. Next is a darker folk record built around winter
> rituals and exile.

Diese Texte sollten vorbereitet und wiederverwendbar sein. Eine automatisch erzeugte
Moderation bei jedem Übergang wäre für den Start unnötig.

### Ausbaustufen

- Sender nach Tageszeit
- persönliche Sender aus lokalem Hörverlauf
- komplette Albumblöcke statt einzelner Tracks
- wöchentliche redaktionelle Shows
- Gastkuratierungen
- Serien-Sender in korrekter Reihenfolge
- geplante Premieren
- kurze Audio-Moderationen

### Erfolgssignale

- gestartete Radio-Sessions
- durchschnittliche Session-Länge
- Wechsel vom Radio auf eine Albumseite
- wiederholte Nutzung desselben Senders
- Anteil übersprungener Tracks

### Empfehlung

Zuerst als Route innerhalb der Music-App testen. Eine eigene Radio-App ist erst
sinnvoll, wenn Nutzer den Lean-back-Modus regelmäßig und unabhängig von der
Album-Navigation verwenden.
...
Eine Discovery-Oberfläche, die nicht mit Genres beginnt, sondern mit Hörsituation,
Stimmung und verfügbarer Zeit.

### Mögliche Auswahl

- Stimmung: düster, ruhig, trotzig, melancholisch, triumphal
- Energie: niedrig, mittel, hoch
- Sprache
- instrumentale oder vokale Musik
- verfügbare Zeit
- einzelnes Album oder fortlaufende Queue
- vertraut oder überraschend

Beispiel:

> Düstere Musik, ungefähr 45 Minuten, nicht auf Englisch, mittlere Energie.

### MVP

- vorhandene Metadaten verwenden
- klar beschriftete Filter
- sofort sichtbare Trefferanzahl
- Ergebnis mit kurzer Begründung
- „Überrasche mich innerhalb dieser Auswahl“
- Filterzustand über URL teilbar

### Ausbaustufen

- gewichtete Präferenzen statt harter Filter
- Übergang zu MelodyMind Radio
- persönliche Vorschläge auf Basis lokaler Hörhistorie
- Tageszeit-Voreinstellungen
- kuratierte Kombinationen

### Empfehlung

Diese Funktion gehört in Music und benötigt keine eigenständige App.
...
Die Startseite zeigt das zuletzt gehörte Album mit aktuellem Track und gespeicherter
Position.

### Kernnutzen

Der globale Player speichert bereits den letzten Zustand lokal. Continue Listening
macht diese vorhandene Funktion sichtbar und verkürzt den Weg zurück zur Musik.
...
- abgeschlossene Alben
- Serienfortschritt
- Übergang in den Listening Passport

### Empfehlung

Sehr guter Quick Win, weil kein neues Konto und kein komplexer Empfehlungsdienst
notwendig sind.
...
Eine vollständige Albumserie wird als zusammenhängende Queue abgespielt.

### Funktionen

- „Play full series“
- korrekte Reihenfolge aller Teile
- Gesamtlaufzeit
- aktueller Fortschritt
- kurze Zusammenfassung vor dem nächsten Album
- Pause zwischen zwei Alben
- Link zur Serienseite

### Ausbaustufen

- „Previously on“ vor jedem Teil
- Story-Zeitleiste über die gesamte Serie
- Figurenentwicklung
- Serienquiz
- Abschlussansicht nach dem letzten Album
- teilbare Fortschrittskarte

### Empfehlung

Früh umsetzen. Die Serienstruktur ist bereits vorhanden und bildet einen direkten Weg
zu längeren Hörsessions.
...
## 14. MelodyMind Visuals

### Idee

Ein Vollbild-Player für Fernseher, Tablets und zweite Bildschirme.

### Ansichten

- Cover und Tracktitel
- Lyrics
- Story-Szenen
- Album-Zeitleiste
- reduzierte Audio-Visualisierung
- „Now Playing“ für Hörabende

### MVP

- Vollbildmodus
- großes Cover
- Track, Album und Fortschritt
- automatische Anpassung an Fernseher und Tablet
- ruhige Hintergrundfarbe aus dem Cover
- Reduced-Motion-Ansicht

### Ausbaustufen

- Lyrics-Modus
- Story-Modus
- Visualizer auf Basis der Web Audio API
- QR-Code zum Öffnen des Albums auf dem Telefon
- Fernsteuerung über ein zweites Gerät

### Empfehlung

Als eigener Player-Modus in Music beginnen. Eine separate TV-App lohnt sich erst bei
echter Nutzung auf großen Displays.
...
Ein Generator für datenschutzfreundliche externe Player.

### Konfiguration

- Album oder Serie
- Starttrack
- kompakte oder ausführliche Darstellung
- Cover anzeigen
- Trackliste anzeigen
- Storybeschreibung anzeigen
- Autoplay grundsätzlich deaktiviert

### MVP

- ein kompakter Albumplayer
- responsiver iframe
- Kopieren des Embed-Codes
- Link zurück zur vollständigen Albumseite

### Ausbaustufen

- Serienplayer
- thematische Sampler
- anpassbare, zugängliche Farbvarianten
- Nutzungsstatistik ohne personenbezogenes Tracking
