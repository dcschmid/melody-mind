...
description:
  Daniel and Annabelle follow how heavy music grew from early blues voices into extreme
  metal, listening through artists, sound, and real musical decisions rather than genre
  labels or hype.
...
Extreme metal did not replace blues. **It pushed the same emotions to a greater
intensity.**
