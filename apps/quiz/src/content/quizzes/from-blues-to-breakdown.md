...
questions:
  - id: question-01
    question: >-
      Heavy music began as emotional weight in the blues, long before volume or
      distortion.
    type: true-false
    difficulty: easy
    options:
  ...
  - id: question-04
    question: >-
      Memphis Minnie was one of the first blues musicians to use electrified instruments
      in her recordings.
    type: true-false
    difficulty: medium
    options:
    ...
    correct: true
    explanation: >-
      True. Memphis Minnie was born in 1897 in Algiers, Louisiana. She was one of the
  ...
  - id: question-06
    question: >-
      Big Mama Thornton's version of 'Hound Dog' was full of energy but received less
      public recognition than later covers.
    type: true-false
    difficulty: medium
    options:
      - "True"
  ...
  - id: question-10
    question: >-
      Which guitarist was known for loud, energetic playing that mixed gospel intensity
      with rock energy before the term 'rock 'n' roll' was coined?
    type: single-choice
    difficulty: medium
    options:
      - Chuck Berry
  ...
  - id: question-13
    ...
    explanation: >-
      ...
      story to it. Bands like Iron Maiden created songs with distinct sections, where
  ...
  - id: question-31
    ...
    correct:
      ...
      - 3
    explanation: >-
      For many heavy music artists, touring remains central to survival but can also lead
  ...
  - id: question-33
    ...
    correct:
      ...
      - 2
    explanation: >-
      Thrash, death, and black metal became three of the main branches in metal's move
