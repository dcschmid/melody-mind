...
| PA-03 | Client-side personalization storage           | Optional UX continuity (reading progress, recent reads)                             | Art. 6(1)(f) GDPR (user experience)       | Website visitors                                                       | LocalStorage keys (`mm_read_progress`, `mm_recent_reads`)                                       |
