...
| PA-05 | Client-side personalization storage           | Optional UX continuity (bookmarks, reading progress, recent reads) | Art. 6(1)(f) GDPR (user experience)       | Website visitors                                                       | LocalStorage keys (`mm_bookmarks`, `mm_read_progress`, `mm_recent_reads`) |
